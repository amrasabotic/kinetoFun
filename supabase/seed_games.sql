...
values
  ('neon-drift', 'Neon Drift', 'Outrun the grid at light speed.',
   ...
   'Action', 'both', 1, 4, 'from-fuchsia-600 via-purple-600 to-indigo-700', null, '#c026d3', 4.7, 2025, 12, true),
  ...
  ('block-cascade', 'Block Cascade', 'Stack, clear, survive.',
   ...
   'Puzzle', 'single', 1, 1, 'from-cyan-500 via-sky-600 to-blue-700', null, '#0ea5e9', 4.4, 2024, 8, true),
  ...
  ('galaxy-strikers', 'Galaxy Strikers', 'Defend the colony, together.',
   ...
   'Arcade', 'multi', 2, 4, 'from-emerald-500 via-teal-600 to-cyan-700', null, '#10b981', 4.6, 2025, 15, true),
  ...
  ('court-kings', 'Court Kings', 'Rule the hardwood.',
   ...
   'Sports', 'both', 1, 4, 'from-orange-500 via-amber-600 to-red-600', null, '#f97316', 4.2, 2023, 20, false),
  ...
  ('shadow-quest', 'Shadow Quest', 'A realm shaped by your choices.',
   ...
   'Adventure', 'single', 1, 1, 'from-violet-700 via-indigo-800 to-slate-900', null, '#7c3aed', 4.8, 2025, 45, true),
  ...
  ('party-panic', 'Party Panic', 'Mini-game mayhem for everyone.',
   ...
   'Party', 'multi', 2, 4, 'from-pink-500 via-rose-500 to-orange-500', null, '#ec4899', 4.5, 2024, 25, false),
  ...
  ('pixel-racer', 'Pixel Racer', 'Retro speed, modern thrills.',
   ...
   'Action', 'both', 1, 4, 'from-lime-500 via-green-600 to-emerald-700', null, '#65a30d', 4.1, 2022, 10, false),
  ...
  ('mind-maze', 'Mind Maze', 'Think your way out.',
   ...
   'Puzzle', 'single', 1, 1, 'from-indigo-500 via-blue-600 to-cyan-600', null, '#6366f1', 4.3, 2023, 18, false),
  ...
  ('aero-dunk', 'Aero Dunk', 'Zero gravity. Maximum hops.',
   ...
   'Sports', 'multi', 2, 4, 'from-sky-500 via-indigo-600 to-violet-700', null, '#3b82f6', 4.0, 2024, 16, false),
  ...
  ('rune-realms', 'Rune Realms', 'Forge a legend with friends.',
   ...
   'Adventure', 'both', 1, 4, 'from-teal-500 via-emerald-600 to-green-700', null, '#14b8a6', 4.6, 2025, 40, true)
