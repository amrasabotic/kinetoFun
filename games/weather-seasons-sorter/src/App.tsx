...
import type { WeatherGameMode, SessionResult } from './types';
...
const CALIBRATED_KEY = 'weather-seasons-sorter-calibrated-v1';

export default function App() {
  const [screen, setScreen] = useState<Screen>(() => (localStorage.getItem(CALIBRATED_KEY) ? 'main-menu' : 'calibration'));
  const [mode, setMode] = useState<WeatherGameMode>('wear');
