...
import type { InstrumentGameMode, SessionResult } from './types';
...
const CALIBRATED_KEY = 'musical-instrument-sounds-calibrated-v1';

export default function App() {
  const [screen, setScreen] = useState<Screen>(() => (localStorage.getItem(CALIBRATED_KEY) ? 'main-menu' : 'calibration'));
  const [mode, setMode] = useState<InstrumentGameMode>('percussion');
