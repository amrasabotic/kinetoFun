...
const STORAGE_KEY = 'kinetofun.gesture-bowling-lane.save.v1';
...
export function recordGame(mode: GameMode, difficulty: Difficulty, score: number, strikes: number) {
  const save = loadSave();
  save.gamesCompleted += 1;
  save.totalStrikes += strikes;
