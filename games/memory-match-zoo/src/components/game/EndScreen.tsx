...
const ENCOURAGEMENT: Record<0 | 1 | 2 | 3, string> = {
  0: 'Nice try! Let’s match some more!',
  1: 'Good job matching!',
  2: 'Great job! You’re a memory star!',
  3: 'Amazing! Perfect memory!',
};
    ...
    <div className="fixed inset-0 bg-gradient-to-br from-[#241454] via-[#301a68] to-[#160c38] flex items-center justify-center text-white overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3 text-center mb-6 text-sm">
          <div><p className="text-white/40 text-[10px] uppercase">Pairs</p><p className="font-bold">{result.pairs}</p></div>
          <div><p className="text-white/40 text-[10px] uppercase">Flips</p><p className="font-bold">{result.flips}</p></div>
