...
import type { ProduceGameMode, SessionResult } from './types';
...
const CALIBRATED_KEY = 'fruit-vegetable-sorter-calibrated-v1';

export default function App() {
  const [screen, setScreen] = useState<Screen>(() => (localStorage.getItem(CALIBRATED_KEY) ? 'main-menu' : 'calibration'));
  const [mode, setMode] = useState<ProduceGameMode>('mixed');
